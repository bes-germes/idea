...
if (isset($_POST['title_req']) && isset($_POST['text_req']) && isset($uniq_path)) {
    ...
    pg_query($db, "INSERT into inc_idea VALUES(" . $postId[0] . ", '$title', '$descr'," . $au->getUserId($_SESSION['hash']) .", 1, '$postTime', '$postTime', null, null, null, null,'$uniq_path', 0, 0, 0, 0)");

    pg_query($db, "INSERT INTO public.inc_executors(idea_id, user_id, role, role_date)VALUES (" . $postId[0] . ", " . $au->getUserId($_SESSION['hash']) . ", 3, '" . $postTime . "');");
